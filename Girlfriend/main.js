...
$(document).ready(function() {
    ...
    function handleLastQuestion() {
        ...
        $("#name-container").html(`<p style="font-size: 20px;text-align:left;">আমার Crush-এর নাম হলো - <span>${girlfriendName} </span></p><br>I Love You <span>${girlfriendName}</span>`);
